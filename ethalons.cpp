...
std::vector<std::pair<std::string, std::pair<double, double>>> ethalons(cv::Mat & img, std::list<std::vector<std::pair<int, int>>> & objects) {
    ...
    std::vector<std::pair<std::string, std::pair<double,double>>> vector;
    vector.push_back(std::make_pair("square" , square));
    vector.push_back(std::make_pair("star", stars));
    vector.push_back(std::make_pair("rectangle", rectangles));
    return vector;
}
...
int classifyAndPlot() {
    ...
    std::list<std::vector<std::pair<int, int>>> objectvector = indexAndColor(img, bg);
    
    std::vector<std::pair<std::string, std::pair<double, double>>> e = ethalons(img, objectvector);
